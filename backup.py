...
start_button = Button(screen, text="Sākt spēli", command=lambda: reset_game(), width=14, height=1, bg='yellow')
...
def door3_safe():
    door3.destroy()
    screen.create_rectangle(285, 252.5, 305, 377.5, fill="brown") 
    screen.create_text(200, 430, text="Spoka nav!", font=("Arial", 10), fill="black")
    screen.create_text(200, 450, text="Tev ir _ dzīvības", font=("Arial", 10), fill="black")
    main.after(2000, reset_game)
